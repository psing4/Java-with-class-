...
public abstract class Company_GUI extends 
JFrame implements ActionListener{	
	...
	public void startUI() {// 메인 UI 실행 메서드
		...
		ml.setText(" 프로그램이 시작 되었습니다.!!" + " (회사 삭제시 번호입력)");	
		...
		JLabel l2 = new JLabel("회사이름");
		JLabel l3 = new JLabel("월지급액");	
	...
	public Company_GUI() {// 생성자, 프레임 초기화
		
		super("Company Manager Application V1.0");
